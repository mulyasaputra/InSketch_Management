...
<div class="recent mt">
  <div class="transaction shadow">
    <div class="card-header flex"><h6 class="m-0 font-weight-bold text-primary">Transaction (<?= date("F  Y"); ?>)</h6></div>
    <div class="contains">
      <?php $i = 1; ?>
      <?php foreach($result as $row) : ?>
        <div class="flex ddd a">
        <span><?= $i; ?>.&nbsp;</span><p><?= $row["activities"]; ?> for Rp. <?= toCurrency($row["nominal"],0); ?></p>
        </div>
      <?php $i++ ?>
      <?php endforeach ?>
    </div>
  ...
  <div class="addmony shadow">
    ...
    <div class="contains">
      ...
      <?php foreach($resultWallet as $row) : ?>
        ...
        <div class="flex ddd">
        <span><?= $i; ?>.&nbsp;</span><p><?php echo("Treasurer added a balance of Rp. ".$balance); ?></p>
        </div>
      <?php $i++ ?>
      <?php endforeach ?>
    </div>
